...
// --- Data layer -------------------------------------------------------
// Talks to the `listings` table in Supabase (see supabase/schema.sql).
// Every function here has one narrow job and the same signature the
// original JSON-file version had — nothing that calls these functions
// (the pages, the API routes) needed to change when this file swapped
// from reading a local file to querying Supabase.
